...
void loop()
{
  if (rf95.available())
  {
    ...
    if (rf95.recv(buf, &len))
    {
      ...
      int temperature = rec_packet.substring(3,5).toInt(); //read range 3-5 of string and turn string into an integer
      int humidity = rec_packet.substring(11,13).toInt(); // read range 11-13 of string and turn string into an integer
